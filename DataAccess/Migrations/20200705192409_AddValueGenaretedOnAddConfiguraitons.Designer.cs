...
namespace DataAccess.Migrations
{
    ...
    [Migration("20200705192409_AddValueGenaretedOnAddConfiguraitons")]
    partial class AddValueGenaretedOnAddConfiguraitons
    {
            ...
            modelBuilder.Entity("Entities.Concrete.VehicleBrand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasAnnotation("Npgsql:IdentitySequenceOptions", "'105', '1', '', '', 'False', '1'")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
