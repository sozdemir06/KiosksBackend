...
namespace DataAccess.Migrations
{
    ...
    [Migration("20200905155715_AddScreenHeaderFooterEntity")]
    partial class AddScreenHeaderFooterEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Concrete.ScreenHeaderPhoto", b =>
                {
                    ...
                    b.Property<int>("ScreenHeaderId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("ScreenHeaderId");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.ScreenHeaderPhoto", b =>
                {
                    b.HasOne("Core.Entities.Concrete.ScreenHeader", "ScreenHeader")
                        .WithMany("ScreenHeaderPhotos")
                        .HasForeignKey("ScreenHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
