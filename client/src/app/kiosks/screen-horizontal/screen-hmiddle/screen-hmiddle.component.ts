...
@Component({
  selector: 'app-screen-hmiddle',
  templateUrl: './screen-hmiddle.component.html',
  styleUrls: ['./screen-hmiddle.component.scss']
})
export class ScreenHmiddleComponent implements OnInit,OnDestroy {
